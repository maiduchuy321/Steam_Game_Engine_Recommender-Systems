...
const Landing = () => {
 ...
 const handleSubmit = (event) => {
    ...
    const formData = {
      response1: [game1, rating1],
      response2: [game2, rating2],
      response3: [game3, rating3],
      response4: [game4, rating4],
      response5: [game5, rating5]
    };
            ...
            <div id='card-input-1' className='card-body-input px-4 pt-2'>
              <div className='flex flex-row justify-center items-center'>
                ...
                <Select className='p-2 basis-[70%]'
                  ...
                  name="game"
                  options={chooseGame}
                  labelField = {chooseGame.gameName[1]}
                  valueField = {chooseGame.gameName[0]}
