      ...
      <div className='card-body'>
        ...
        <div className='card-body-container'>
          ...
          <form>
            ...
            </div><div id='card-input-1' className='card-body-input p-4'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 3:</label>
            ...
            </div><div id='card-input-4' className='card-body-input p-4'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 4:</label>
            ...
            </div><div id='card-input-5' className='card-body-input p-4'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 5:</label>
