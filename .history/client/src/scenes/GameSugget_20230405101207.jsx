...
const GameSugget = () => {
  return (
    <div className='flex flex-wrap'>
        ...
        <img className='mx-auto w-[460px] h-[215px]' src={defaultImg1}/>
        <img className='mx-auto w-[460px] h-[215px]' src={defaultImg2}/>
        <img className='mx-auto w-[460px] h-[215px]' src={defaultImg3}/>
        <img className='mx-auto w-[460px] h-[215px]' src={defaultImg4}/>
