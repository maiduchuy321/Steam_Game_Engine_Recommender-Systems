          ...
          <form>
            ...
            <div class="flex flex row justify-center mt-3">
              <div class="col-md-2 mb-2 mb-md-0">
                <button id="getRecommendationsButton" type='submit' class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Submit</button>
              </div>
              <div class="col-md-2">
                <button id="resetRecommendationsButton" class="btn btn-secondary w-100">Reset</button>
              </div>
            </div>
