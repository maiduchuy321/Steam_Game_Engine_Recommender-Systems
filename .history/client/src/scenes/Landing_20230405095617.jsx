          ...
          <form>
            ...
            <div className="flex flex-row justify-center mt-3">
              <div className="shrink-0 w-1/6 mb-2 px-2 text-center">
                <button id="getRecommendationsButton" type='submit' className="w-full bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 border border-yellow-700 rounded">Submit</button>
              </div>
