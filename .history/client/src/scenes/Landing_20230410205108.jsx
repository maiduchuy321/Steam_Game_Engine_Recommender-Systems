...
const Landing = () => {
  ...
  const handleSubmit = (event) => {
    ...
    .then(response => {
      ...
      document.getElementById("img1").src = arr[0][1];
      document.getElementById("img2").src = arr[1][1];
      document.getElementById("img3").src = arr[2][1];
      document.getElementById("img4").src = arr[3][1];
      document.getElementById("img5").src = arr[4][1];
