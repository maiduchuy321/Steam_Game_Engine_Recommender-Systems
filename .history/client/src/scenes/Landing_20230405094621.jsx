          ...
          <form>
            ...
            <div className="flex flex-row justify-center mt-3">
              ...
              <div class="shrink-0 w-1/6 mb-2 px-2 text-center">
                <button id="resetRecommendationsButton" type='reset' className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Reset</button>
              </div>
            </div>
