    ...
    <div className='card mx-auto my-4 max-w-[80%] bg-[#f2f2f2] p-4'>
      <div className='card-body'>
        ...
        <div className='card-body-container'>
          ...
          <form>
            <div id='card-input-1' className='card-body-input p-4 pb-0'>
            ...
            <div id='card-input-2' className='card-body-input p-4 pb-0'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 2:</label>
            ...
            <div id='card-input-3' className='card-body-input p-4 pb-0'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 3:</label>
            ...
            <div id='card-input-4' className='card-body-input p-4 pb-0'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 4:</label>
            ...
            <div id='card-input-5' className='card-body-input p-4 pb-0'>
              <div className='flex flex-row justify-center items-center'>
                <label>Game 5:</label>
