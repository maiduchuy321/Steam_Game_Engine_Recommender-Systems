          ...
          <form>
            ...
            <div className="flex flex-row justify-center mt-3">
              ...
              <div class="shrink-0 w-1/6 mb-2 px-2 text-center">
                <button id="resetRecommendationsButton" className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Reset</button>
              </div>
            </div>
