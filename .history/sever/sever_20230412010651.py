...
def home():
    ...
    lst = []
    # Vòng lặp tiếp theo tạo một danh sách lst chứa tên và đường dẫn hình ảnh của 5 trò chơi tương tự nhất. Tên và đường dẫn được lấy từ một tập dữ liệu endpoint_dataset_final.csv được đọc vào biến endpoint ở đầu chương trình.
