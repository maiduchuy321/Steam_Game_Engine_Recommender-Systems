...
#     # Lấy o_name và header_image
#     appid_header_image = merged_df[['o_name', 'header_image']].values.tolist()
#     # Chuyển đổi từ list của list sang list của tuple
#     appid_header_image_tuples = [tuple(row) for row in appid_header_image]
#     print(appid_header_image_tuples)
#     result = {"result": appid_header_image_tuples}
